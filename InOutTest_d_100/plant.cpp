...
Plant::Plant()
{
    ...
    gain_1 = new gain(1 );
    gain_2 = new gain(-0.0007 );
    gain_3 = new gain(-0.0147);
    gain_4 = new gain(0.0999);
    gain_5 = new gain(0.9973);
    gain_6 = new gain(-0.0547);
    gain_7 = new gain(0.0049);
    gain_8 = new gain(0.0982);
    gain_9 = new gain(0.9629);
    gain_10 = new gain(0.1481);
    gain_11 = new gain(0.0506);
    gain_12 = new gain(0.2482);
    //init out of delay
