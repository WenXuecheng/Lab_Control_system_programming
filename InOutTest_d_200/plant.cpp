...
Plant::Plant()
{
    ...
    gain_1 = new gain(0.9998 );
    gain_2 = new gain(-0.0029);
    gain_3 = new gain(-0.0289);
    gain_4 = new gain(0.1993);
    gain_5 = new gain(0.9891);
    gain_6 = new gain(-0.1088);
    gain_7 = new gain(0.0195);
    gain_8 = new gain(0.1924);
    gain_9 = new gain(0.9217);
    gain_10 = new gain(0.2926);
    gain_11 = new gain(0.1023);
    gain_12 = new gain(0.4928);
    //init out of delay
